...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary: 'bg-navy-600 hover:bg-navy-700 text-white shadow-sm focus:ring-navy-500 border border-transparent',
    outline: 'border border-navy-300 bg-white text-navy-700 hover:bg-navy-50 focus:ring-navy-500',
