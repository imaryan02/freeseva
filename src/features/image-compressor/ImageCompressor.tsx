                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="w-12 h-12 rounded-lg bg-navy-200 flex-shrink-0 overflow-hidden border border-navy-300 flex items-center justify-center shadow-sm relative select-none">
                          ...
                          <span className="absolute bottom-0 inset-x-0 bg-black/60 text-[8px] text-white text-center py-0.2 select-none" title={`Original footprint footprint size: ${formatBytes(item.file.size)}`}>
                        ...
                        <div className="min-w-[110px]">
                          ...
                          <div className="flex items-center">
                            <span className="px-2.5 py-1 text-[11px] font-extrabold uppercase rounded-lg border border-brand-200 bg-brand-50 text-brand-750 tracking-wide select-none">
                        ...
                        {/* 5. SIZE TARGET (Enlarged and Spaced!) */}
