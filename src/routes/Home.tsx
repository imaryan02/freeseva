      ...
      <main id="home">
        <section className="mx-auto px-5 py-8 md:px-8 md:py-10">
          <div className="relative mx-auto grid max-w-7xl items-center gap-8 overflow-hidden rounded-[2rem] border border-white/80 bg-white/72 px-6 py-8 text-center shadow-[0_30px_90px_rgba(31,49,82,0.10)] backdrop-blur-xl md:px-10 md:py-12 lg:grid-cols-[0.96fr_1.04fr] lg:gap-10 lg:px-12 lg:text-left">
            ...
            <div className="relative z-10 mx-auto min-h-[340px] w-full max-w-[640px] select-none md:min-h-[430px] lg:max-w-none">
              ...
              <div className="absolute left-1/2 top-1/2 flex h-80 w-80 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-[3rem] bg-white/45 shadow-[0_30px_90px_rgba(74,103,170,0.18)] backdrop-blur-sm md:h-[25rem] md:w-[25rem]">
                <img
                  src="/freeseva.png"
              ...
              {[
                { label: 'Fast', sub: 'Quick tools', icon: <Zap className="h-5 w-5 text-violet-600" />, pos: 'left-1 top-16' },
                { label: 'Private', sub: 'Browser local', icon: <Lock className="h-5 w-5 text-navy-700" />, pos: 'right-0 top-24' },
                { label: 'Easy', sub: 'One click', icon: <MousePointerClick className="h-5 w-5 text-navy-700" />, pos: 'left-0 bottom-20' },
                { label: 'Community', sub: 'Free service', icon: <HeartHandshake className="h-5 w-5 text-navy-700" />, pos: 'right-3 bottom-12' },
              ].map((badge) => (
                <div
                  key={badge.label}
